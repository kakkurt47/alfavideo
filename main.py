...
def button():
	InlineKeyboardButton ( "🎉 𝖡𝖾𝗇𝗂 𝖦𝗋𝗎𝖻𝖺 𝖤𝗄𝗅𝖾 🎉" , url = f"http://t.me/KelimeUret_Bot?startgroup=new" )
    ],
    [
        InlineKeyboardButton ( "🇹🇷 𝖮𝗐𝗇𝖾𝗋 " , url = "t.me/Kakkurt47" ),
        InlineKeyboardButton ( "✏️ 𝖪𝖺𝗇𝖺𝗅 " , url = "t.me/kelimeuret" ),
    ],
    [
        InlineKeyboardButton ( "✍🏻 𝖮𝗒𝗎𝗇 𝖦𝗋𝗎𝖻𝗎 ✍🏻" , url = "t.me/tutkuoyun" )
    ]
